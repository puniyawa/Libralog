                ...
                <form class="needs-validation" method="post" style="width:50vw; min-width:300px;" novalidate>
                    <div class="row mb-3">
                        <div class="mb-3">
                            <div class="col">
                                <label for="" class="form-label">UID:</label>
                                <input type="text" class="form-control" name="uid" value="<?php echo $uid?>" <?php echo ($isInDatabase == true) ? "readonly": ""?>>
                                <div class="invalid-feedback">Enter your UID</div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="studentID" required value="<?php echo $studentID?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
                                <div class="invalid-feedback">Enter your Student ID</div>
                            </div>
                        </div>                        
                        <div class="col">
                            <label for="" class="form-label">First Name:</label>
                            <input type="text" class="form-control" name="firstName" required value="<?php echo $firstName?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
                            <div class="invalid-feedback">You must fill out the form</div>
                        </div>
                        <div class="col">
                            <label for="" class="form-label">Middle Name:</label>
                            <input type="text" class="form-control" name="middleName" required value="<?php echo $middleName?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
                            <div class="invalid-feedback">Please provide your complete middle name</div>
                        </div>
                        <div class="col">
                            <label for="" class="form-label">Last Name:</label>
                            <input type="text" class="form-control" name="lastName" required value="<?php echo $lastName?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-2">
                            ...
                            <input type="text" class="form-control" name="gradeYear" required value="<?php echo $gradeYear?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
                            <div class="invalid-feedback">Provide you grade/year level</div>
                        </div>
                        <div class="col-4">
                            <label for="" class="form-label">Section:</label>
                            <input type="text" class="form-control" name="section" required value="<?php echo $section?>" <?php echo ($isInDatabase == true) ? "disabled": ""?>>
